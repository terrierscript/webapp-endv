...
import { LexicalEntry, Sense, Synset, LexicalEntryIndex, Behavior, SenseIndexRelation } from "./types"
...
export const getSenseIndex = (id: string | undefined): SenseIndexRelation[] | undefined => id && dictionary.getSenseIndex(id)
